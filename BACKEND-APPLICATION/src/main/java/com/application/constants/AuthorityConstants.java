...
public class AuthorityConstants {
    ...
    public static final String[] OWNER_AUTHORITIES = {"user:read", "hotel:create", "hotel:read", "hotel:update", "hotel:delete", "room:create", "room:read", "room:update", "room:delete"};
